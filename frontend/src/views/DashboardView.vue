...
import ocrVideo from '@/video/ocrtest-browser.mp4'
      ...
      <section class="main-grid">
        ...
        <article class="glass panel">
          ...
          <div class="vehicle-stage">
            <video class="vehicle-video" autoplay loop muted playsinline controls preload="auto">
              <source :src="ocrVideo" type="video/mp4" />
            </video>
          </div>
