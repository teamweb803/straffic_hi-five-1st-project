...
.zone-input-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}
.zone-input-grid label{display:grid;gap:7px}
.zone-input-grid span{color:#8ca5c8;font-size:11px;font-weight:800}
.zone-input-grid input{height:38px;padding:0 10px;border:1px solid rgba(79,171,255,.24);border-radius:10px;background:rgba(3,10,24,.56);color:#e8f3ff;font:inherit}
.gps-map .zone{left:20%;top:22%;width:60%;height:56%;border:2px solid rgba(51,230,161,.85);border-radius:0;background:rgba(51,230,161,.06);box-shadow:0 0 22px rgba(51,230,161,.16) inset}
.gps-point{width:10px;height:10px;transform:translate(-50%,-50%)}
.gps-point.trail{width:6px;height:6px;opacity:.45}
.gps-point.center{width:12px;height:12px;background:#ffd166;box-shadow:0 0 16px #ffd166}
.gps-point.actual{width:14px;height:14px;background:#38bef5}
.gps-point.actual.outside{background:#ff5d6c;box-shadow:0 0 18px #ff5d6c}
.gps-point em{position:absolute;left:13px;top:-9px;white-space:nowrap;padding:2px 6px;border-radius:999px;background:rgba(3,10,24,.88);color:#e8f3ff;font-size:10px;font-style:normal;font-weight:900}
.gps-summary{align-content:start}
.ocr-gps-detail,.detail-info-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:14px;transition:grid-template-columns .2s ease}
.ocr-gps-detail.focus-ocr,.detail-info-grid.focus-ocr{grid-template-columns:1.45fr .55fr}
.ocr-gps-detail.focus-gps,.detail-info-grid.focus-gps{grid-template-columns:.55fr 1.45fr}
.detail-cell,.info-card{min-width:0;border:1px solid rgba(79,171,255,.14);border-radius:14px;background:rgba(3,10,24,.34);padding:12px}
.cell-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;color:#8ca5c8;font-size:12px;font-weight:800}
.cell-head strong{color:#e8f3ff}.ocr-gps-detail .vehicle-stage{height:260px}.ocr-gps-detail .gps-map{height:260px;min-height:260px}
.ocr-gps-detail.focus-ocr .ocr-cell .vehicle-stage,.ocr-gps-detail.focus-gps .gps-cell .gps-map{height:360px;min-height:360px}
.ocr-gps-detail.focus-ocr .gps-cell .gps-map,.ocr-gps-detail.focus-gps .ocr-cell .vehicle-stage{height:220px;min-height:220px}
.info-card h3{margin:0 0 10px;color:#e8f3ff;font-size:14px}.info-card .detail-grid{grid-template-columns:repeat(2,1fr);margin-top:0}.info-card .gps-summary{grid-template-columns:1fr;gap:8px}
.detail-info-grid.focus-ocr .ocr-info .detail-grid{grid-template-columns:repeat(3,1fr)}.detail-info-grid.focus-gps .gps-info .gps-summary{grid-template-columns:repeat(2,1fr)}
.modal-backdrop{position:fixed;inset:0;z-index:80;display:grid;place-items:center;padding:24px;background:rgba(2,8,20,.72);backdrop-filter:blur(8px)}
.zone-modal{width:min(880px,calc(100vw - 48px));padding:22px}
.modal-copy{margin:0 0 16px;color:#8ca5c8;font-size:13px;line-height:1.6}
.zone-modal .zone-input-grid{grid-template-columns:repeat(2,1fr);margin-bottom:16px}
</style>
